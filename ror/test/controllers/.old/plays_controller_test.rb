...
class PlaysControllerTest < ActionDispatch::IntegrationTest
  ...
  #    post plays_url, params: { play: { Follow: @play.Follow, Rate: @play.Rate } }
  #  end
  ...
  #  patch play_url(@play), params: { play: { Follow: @play.Follow, Rate: @play.Rate } }
